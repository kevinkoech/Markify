...
const trainerLinks = [
  { href: "/dashboard", label: "Dashboard", icon: "home" },
  { href: "/dashboard/units", label: "Units", icon: "book" },
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
        ...
        <span className="font-semibold text-gray-900">Engineering Training</span>
        <div className="w-10" />
      </div>
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
            <Link href="/dashboard" className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-gray-900">Marking System</span>
            </Link>
            <button
          ...
          <div className="border-t border-gray-200 p-4">
            ...
            <form action={logout}>
              <button
                type="submit"
                className="w-full flex items-center justify-center space-x-2 px-3 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors"
              >
